...
def synthesize1(model, configs, vocoder, batch, control_values, args, style_vector):
...
if __name__ == "__main__":
    ...
    for lang, text in zip(language, texts):
        ...
        synthesize1(model, configs, vocoder, batch, control_values, args, style_vector=style_vector)
