...
from util import pad_1D, pad_2D, process_meta
...
if __name__ == "__main__":
    import pdb
    path = "/home/chungtran/Code/TTS/StyleSpeech/dataset/wav22050_processed"
    data_loader = prepare_dataloader(path, "train.txt", shuffle=True, batch_size=2)
