...
def processing_duration_unseen(raw_path, info, target=3, delta=0.5):
    max_wav_value = 32766
    # lang, speaker, file_name, duration = info.strip().split("|")
    ...
    # duration = float(duration)
    path_file = os.path.join(raw_path, lang, speaker, file_name)
    wav_audio, sr = librosa.load(path_file, 22050)
    wav_audio, _ = librosa.effects.trim(wav_audio)
    wav_audio = wav_audio / max(abs(wav_audio)) * max_wav_value
    #### new duration ####
    duration = wav_audio.shape[0] / sr
    ...
    write(path_orginal_audio, sr, wav_audio_limit5s.astype(np.int16))
    ### take random other ground-truth
    path_mosgt = glob.glob(os.path.join(raw_path, lang, speaker, "*.flac"))
    random.shuffle(path_mosgt)
    path_mosgt = path_mosgt[0]
    ###
    if (target-delta) <= duration <= (target+delta):# around target +- delta
...
def get_model():
    ...
    # # #########################
    args.restore_step = "40000_FreezeFS_3500_V2_1"
    ...
    # args.preprocess_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_diffusion_style_6L/preprocess.yaml"
    # args.model_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_diffusion_style_6L/model.yaml"
    # args.train_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_diffusion_style_6L/train.yaml"
    # preprocess_config = yaml.load(
    #     open(args.preprocess_config, "r"), Loader=yaml.FullLoader
    # )
    # model_config = yaml.load(open(args.model_config, "r"), Loader=yaml.FullLoader)
    ...
    # # ###########################################################################
    # args.restore_step = "330000"
    # args.preprocess_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_diffusion_style_6L_balance/preprocess.yaml"
    # args.model_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_diffusion_style_6L_balance/model.yaml"
    # args.train_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_diffusion_style_6L_balance/train.yaml"
    # preprocess_config = yaml.load(
    #     open(args.preprocess_config, "r"), Loader=yaml.FullLoader
    # )
    # model_config = yaml.load(open(args.model_config, "r"), Loader=yaml.FullLoader)
    ...
    # configs = (preprocess_config, model_config, train_config)
    # model = get_model_fastSpeech2_StyleEncoder_MultiLanguage_Difffusion_Style1(args, configs, device, train=False)
    # model_name = "fastspeech2_diffusion_Style_balance"
    # yield [model, model_name, configs, args]

    # ###########################################################################
    # args.restore_step = "Original_Norm_EVD_DF_V2_12000"
    # args.preprocess_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_DFS_LS_6L_balance_Lang/preprocess.yaml"
    # args.model_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_DFS_LS_6L_balance_Lang/model.yaml"
    # args.train_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_DFS_LS_6L_balance_Lang/train.yaml"
    # preprocess_config = yaml.load(
    #     open(args.preprocess_config, "r"), Loader=yaml.FullLoader
    # )
    # model_config = yaml.load(open(args.model_config, "r"), Loader=yaml.FullLoader)
    # train_config = yaml.load(open(args.train_config, "r"), Loader=yaml.FullLoader)
    # configs = (preprocess_config, model_config, train_config)
    # model = get_model_fastSpeech2_StyleEncoder_MultiLanguage_Difffusion_Style_Language1(args, configs, device, train=False)
    # model_name = "fastspeech2_DFS_LS_6L_balance"
    # yield [model, model_name, configs, args]
    ...
    # # ###########################################################################
    # args.restore_step = "9000"
    # args.preprocess_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_diffusion_style_CN/preprocess.yaml"
    # args.model_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_diffusion_style_CN/model.yaml"
    # args.train_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_diffusion_style_CN/train.yaml"
    # preprocess_config = yaml.load(
    #     open(args.preprocess_config, "r"), Loader=yaml.FullLoader
    # )
    # model_config = yaml.load(open(args.model_config, "r"), Loader=yaml.FullLoader)
    ...
    # args.restore_step = "10000"
    # args.preprocess_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_diffusion_style_JA/preprocess.yaml"
    # args.model_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_diffusion_style_JA/model.yaml"
    # args.train_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_diffusion_style_JA/train.yaml"
    # preprocess_config = yaml.load(
    #     open(args.preprocess_config, "r"), Loader=yaml.FullLoader
    # )
    # model_config = yaml.load(open(args.model_config, "r"), Loader=yaml.FullLoader)
    ...
    # args.preprocess_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_diffusion_style_IN/preprocess.yaml"
    # args.model_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_diffusion_style_IN/model.yaml"
    # args.train_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_diffusion_style_IN/train.yaml"
    # preprocess_config = yaml.load(
    #     open(args.preprocess_config, "r"), Loader=yaml.FullLoader
    # )
    # model_config = yaml.load(open(args.model_config, "r"), Loader=yaml.FullLoader)
    ...
    #
    # args.restore_step = "9000"
    # args.preprocess_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_diffusion_style_EN/preprocess.yaml"
    # args.model_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_diffusion_style_EN/model.yaml"
    # args.train_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_diffusion_style_EN/train.yaml"
    # preprocess_config = yaml.load(
    #     open(args.preprocess_config, "r"), Loader=yaml.FullLoader
    # )
    # model_config = yaml.load(open(args.model_config, "r"), Loader=yaml.FullLoader)
    ...
    # args.restore_step = "10000"
    # args.preprocess_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_diffusion_style_KO/preprocess.yaml"
    # args.model_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_diffusion_style_KO/model.yaml"
    # args.train_config = "../config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_diffusion_style_KO/train.yaml"
    # preprocess_config = yaml.load(
    #     open(args.preprocess_config, "r"), Loader=yaml.FullLoader
    # )
    # model_config = yaml.load(open(args.model_config, "r"), Loader=yaml.FullLoader)
...
if __name__ == "__main__":
    ...
    corpus_path = "/home/ldap-users/s2220411/Code/FastSpeech2_multilingual/visualization/audio/synthesis_audio_interspeech2023_Recognition"
    target_MOS_file = "gt_5secondV3_SIM.json"
    # target_MOS_file = "gt_5secondVietnam.json"
    # target_MOS_file = "Unseen_speaker_3Speaker.json"
    unseen_data = False #number_speaker = 2
    seen_data = True; number_speaker = 18
    total_line = []
    ...
    for [model, model_name, configs, args] in get_model():
        ...
        target_duration = [3, 5, 10]
        total_index = 0
        for target_index, target in enumerate(target_duration):
            control_values = args.pitch_control, args.energy_control, args.duration_control
            for lang_i in language:
                ofset = number_speaker*target_index
                text_language = Lang_Text[lang_i][ofset:ofset+number_speaker]
                for text_index, item_text in enumerate(text_language):
                    ...
                    print("-"*20)
                    print("model_name: ", model_name, "target: ", target)
                    ...
                    if seen_data: # for seen data
                        path_file_target_duration, path_orginal_audio, path_mosgt = processing_duration(raw_path, target_speaker, target=target)
                    elif unseen_data:
                        path_file_target_duration, path_orginal_audio, path_mosgt = processing_duration_unseen(raw_path, target_speaker, target=target)
                    ...
                    filename_mos = f"{lang_i}_{model_name}_{target}_{target_speaker_name}_{filename_speaker}_{language_gt_id}_UNSEEN_{total_index}"+".wav"
                    filename_sim = f"{lang_i}_{model_name}_{target}_{target_speaker_name}_{filename_speaker}_{language_gt_id}_UNSEEN_{total_index}_groundtruth"+".wav"
