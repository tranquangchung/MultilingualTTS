...
if __name__ == "__main__":
    ...
    for lang in language:
        with open(f'/home/ldap-users/s2220411/Code/Multilingual_Data_Training/selective_sentencesV3/{lang}.json') as fin:
            texts = fin.readlines()
            Lang_Text[lang] = texts
    kwargs = {"use_pinyin": True}
    corpus_path = "/home/ldap-users/s2220411/Code/FastSpeech2_multilingual/visualization/synthesis_audio_interspeech2023"
    target_MOS_file = "gt_5secondV2_SIM.json"
