...
'''
class ECAPA_TDNN_Discriminator(nn.Module):
    def __init__(self, in_channels=80, channels=512, embd_dim=1):
        super().__init__()
...
if __name__ == '__main__':
    ...
    model = ECAPA_TDNN_Discriminator(in_channels=80, channels=512, embd_dim=1)
    out = model(x)
    print(model)
