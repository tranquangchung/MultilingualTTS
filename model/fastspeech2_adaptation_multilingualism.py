...
class FastSpeech2_Adaptation_Multilingualism(nn.Module):
    """ FastSpeech2 """

    def __init__(self, preprocess_config, model_config):
        super(FastSpeech2_Adaptation_Multilingualism, self).__init__()
    ...
    def forward(
        ...
        if self.language_emb is not None:
            output = output + self.language_emb(languages)
