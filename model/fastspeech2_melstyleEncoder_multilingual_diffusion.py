...
from .blocks_diffusion import LinearNorm
from .modules_diffusion import FastspeechEncoder, FastspeechDecoder, VarianceAdaptor
from .diffusion import GaussianDiffusion, GaussianDiffusionShallow
from utils.tools import get_mask_from_lengths
import pdb

class FS_Multilingual_Diffusion(nn.Module):
    """ FS_Multilingual_Diffusion """

    def __init__(self, args, preprocess_config, model_config, train_config):
        super(FS_Multilingual_Diffusion, self).__init__()
