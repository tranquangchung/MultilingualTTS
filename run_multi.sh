...
# -p config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_test/preprocess.yaml \
# -m config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_test/model.yaml \
# -t config/config_pcgpu/LibriTTS_StyleSpeech_multilingual_test/train.yaml
...
#CUDA_VISIBLE_DEVICES=0 python3 train_multi_diffusion.py \
# -p config/config_kaga/LibriTTS_StyleSpeech_multilingual_diffusion_style_6L_balance/preprocess.yaml \
# -m config/config_kaga/LibriTTS_StyleSpeech_multilingual_diffusion_style_6L_balance/model.yaml \
# -t config/config_kaga/LibriTTS_StyleSpeech_multilingual_diffusion_style_6L_balance/train.yaml \
# --model "shallowstyle"