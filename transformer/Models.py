...
class Encoder_StyleSpeech(nn.Module):
    """ Encoder """

    def __init__(self, config):
        super(Encoder_StyleSpeech, self).__init__()
    ...
    def forward(self, src_seq, style_vector, mask, return_attns=False):
        batch_size, max_len = src_seq.shape[0], src_seq.shape[1]
...
class Decoder_StyleSpeech(nn.Module):
    """ Decoder """

    def __init__(self, config):
        super(Decoder_StyleSpeech, self).__init__()
    ...
    def forward(self, enc_seq, style_vector, mask, return_attns=False):
...
class Encoder_StyleSpeech_Discriminator(nn.Module):
    """ Encoder """

    def __init__(self, config):
        super(Encoder_StyleSpeech_Discriminator, self).__init__()
